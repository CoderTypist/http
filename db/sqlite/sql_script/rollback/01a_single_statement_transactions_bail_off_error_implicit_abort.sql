...
/*
    ...
    Since we didn't specify '.bail on', execution will continue.
    This means that 'luke' and 'john' will still get added to the table.
*/
INSERT INTO USERS (username) VALUES ('person', 'person@gmail.com');
